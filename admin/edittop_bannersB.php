...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($updates)) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: edit_top_bannersB.php");
                exit();
            } else {
    ...
    $result = $conn->query("SELECT * FROM banners WHERE id = $id");
...
<body>
    <div class="container">
        ...
        <a class="back-link" href="edit_top_bannersB.php">Back to Banners List</a>
    </div>
</body>
</html>
