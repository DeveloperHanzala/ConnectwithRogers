    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h1 class="card-title" style="font-weight:bold;font-size:30px;">Limited Time Offers</h1>

              <!-- General Form Elements -->
              <form action="limted_offers_insertion.php" method="POST" enctype="multipart/form-data">
