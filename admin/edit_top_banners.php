...
if (isset($_GET['delete'])) {
    ...
    window.location.href = 'edit_top_banners.php';
  </script>";
    exit();
}
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><img src='uploads/" . htmlspecialchars($row['file']) . "' alt='Image' style='width:100px;height:100px;'></td>";
                
                // Edit button
                echo "<td><a href='edittop_banners.php?id=" . $row['id'] . "' class='edit-btn'>Edit</a></td>";
...
function redirectToPage(value) {
    if (value === "B2C") {
        window.location.href = "edit_top_bannersB.php"; // Redirect to index.php if B2C is selected
    } else if (value === "Connect with rogers") {
        window.location.href = "edit_top_banners.php"; // Redirect to booking.php if Connect with rogers is selected
    }
}
</script>
</body>
